...
const zra_1 = require("../zra");
describe('ZRA Integration', () => {
    let service;
    beforeEach(() => {
        service = new zra_1.ZRAService();
    ...
    describe('VAT Calculation', () => {
        ...
        it('should handle individual customers', async () => {
            const calculation = Object.assign(Object.assign({}, validCalculation), { customerType: 'individual' });
...
//# sourceMappingURL=zra.test.js.map